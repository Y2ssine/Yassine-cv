document.addEventListener("DOMContentLoaded", async () => {
    ...
    const ttsLines = [
        "Yassine: Hi! I'm Yassine Mouihate, a 20-year-old software developer passionate about",
    ...
    document.getElementById("age").textContent = new Date().getFullYear() - 2001;
    ...
    function startTalking() {
        dialogueInterval = setInterval(() => {
            ...
            dialogueText.textContent = "Yassine: " + ttsLines[currentLineIndex];
            currentLineIndex++;
        }, 5000);
    }
});
...
function copyEmail() {
    navigator.clipboard.writeText("Yassinemht0@gmail.com");
    if (cooldown) return;
    cooldown = true;
