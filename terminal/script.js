...
document.getElementById("red-dot").onclick = () => location.href = "https://YassineMouihate.com";
document.getElementById("minimize-dot").onclick = () => location.href = "https://YassineMouihate.com";
...
function executeCommand(userCmd) {
    ...
    else if (userCmd === "poweroff" || userCmd === "exit") location.href = "https://YassineMouihate.com";
